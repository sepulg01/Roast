...
function buildReadmeRows() {
  return [
    ...
    ['Arquitectura', 'WhatsApp Cloud API', 'Alertas y botones operativos', 'Envia alertas para pending_transfer, paid y delivering; los botones llegan por webhook firmado'],
    ...
    ['Worker endpoints', 'GET/POST /api/whatsapp/webhook', 'Webhook Meta WhatsApp', 'Verifica challenge y procesa botones firmados desde telefonos autorizados'],
    ...
    ['Variables y secretos', 'WHATSAPP_TEMPLATE_TRANSFER_ACTIONS', 'Worker secret opcional', 'Template Meta con botones para pending_transfer'],
    ['Variables y secretos', 'WHATSAPP_TEMPLATE_PAID_ACTIONS', 'Worker secret opcional', 'Template Meta con boton para paid'],
    ['Variables y secretos', 'WHATSAPP_TEMPLATE_DELIVERING_ACTIONS', 'Worker secret opcional', 'Template Meta con boton para delivering'],
    ['Variables y secretos', 'WHATSAPP_TEMPLATE_LANGUAGE', 'Worker variable opcional', 'Default recomendado es_CL'],
    ['Variables y secretos', 'WHATSAPP_WEBHOOK_VERIFY_TOKEN', 'Worker secret opcional', 'Token de verificacion del webhook Meta'],
    ['Variables y secretos', 'WHATSAPP_APP_SECRET', 'Worker secret opcional', 'Secreto de app Meta para validar X-Hub-Signature-256'],
    ['Variables y secretos', 'WHATSAPP_ACTION_SECRET', 'Worker secret opcional', 'Firma payloads de botones operativos WhatsApp'],
    ['Variables y secretos', 'WHATSAPP_OPERATOR_PHONES', 'Worker secret opcional', 'Numeros autorizados para ejecutar botones WhatsApp'],
