...
function buildReadmeRows() {
  return [
    ...
    ['Worker endpoints', 'POST /api/checkout-orders', 'Checkout 2 pasos y transferencia bancaria', 'Crea pedido pending_transfer y devuelve datos BCI'],
    ...
    ['Variables y secretos', 'APPS_SCRIPT_WEBHOOK_URL', 'Worker secret para notificaciones/contacto manual', 'Activa email operativo junto al shared secret si ese flujo se usa'],
    ...
    ['Checklist de prueba', '3', 'Confirmar transferencia', 'Debe escribir Clientes, Ventas, Lineas_Pedido y Eventos con estado pending_transfer'],
