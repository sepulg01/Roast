# Cafe Roast — Brand Context Document

---

## 1. Qué es Cafe Roast

Cafe Roast es una marca chilena de café D2C (directo al consumidor) que vende café en grano tostado, molido a pedido según el método de preparación de cada cliente. Opera desde Santiago, Chile, y despacha en la Región Metropolitana.
...
1. **Sabor real.** El instantáneo es café procesado hasta perder lo que lo hace café. Cafe Roast es grano tostado, molido al momento del pedido. La diferencia es inmediata y notoria.
...
**Habla de tú, siempre.** Cafe Roast no usa "usted". Es una conversación entre personas.

**Directo al punto.** No hay rodeos, no hay frases corporativas, no hay palabras de relleno. Si algo se puede decir en cinco palabras, no se dice en diez.
...
| Nombre | Hex | Uso |
|---|---|---|
| Naranja Roast | `#FF6B35` | Color principal de marca. CTAs, destacados, logo, acentos. |
| Negro profundo | `#0D0D0D` | Fondo principal. Base de la identidad oscura. |
| Crema cálida | `#F5F0E8` | Texto principal sobre fondo oscuro. |
| Amarillo acento | `#FFD166` | Acento secundario. Precios, badges secundarios, énfasis puntual. |
| Superficie oscura | `#1A1A1A` | Fondo de cards y superficies elevadas. |
...
| Familia | Peso | Uso |
|---|---|---|
| Space Grotesk | 700 | Titulares, nombre de marca, números grandes, claims principales. |
| Inter | 400 / 500 / 600 | Cuerpo de texto, botones, labels, descripciones. |

Space Grotesk en 700 con tracking negativo (−0.02em) es la voz visual de la marca. Es lo que da el carácter tipográfico: moderno, denso, directo.
...
El wordmark es "Roast" en Space Grotesk 700, seguido de un punto naranja (`#FF6B35`). El punto es parte integral del logo — no es decorativo. Refuerza el nombre truncado y el doble sentido de la marca.

---

## 7. Directrices para generación de imágenes con IA

### Espíritu visual buscado

Oscuro, cálido, urbano. Café real — no café de revista de lifestyle. La imagen debe sentirse cercana, no aspiracional. Si una imagen parece un anuncio de hotel boutique, está mal. Si parece que alguien la sacó en su cocina con buena luz, está bien.

### Prompts recomendados como base

Para producto:
> "Close-up of dark roasted coffee beans on a dark wooden surface, warm dramatic lighting, moody atmosphere, shallow depth of field, no text, photorealistic"

Para taza/preparación:
> "Fresh brewed coffee being poured into a simple ceramic mug on a dark kitchen counter, morning light from the side, steam visible, warm tones, candid feel, no branding"

Para bolsa de producto:
> "Matte black coffee bag with valve on a dark surface, minimal, product photography, soft orange accent light from the left, no text visible"

### Qué evitar en imágenes

- Fondos blancos o beige tipo catálogo
- Café servido en mesas de madera blanca con flores y libros (estética de lifestyle blog)
- Personas sonriendo sosteniendo tazas en contextos perfectos
- Colores saturados o paletas que no pertenezcan a la marca (verdes brillantes, azules, rojos)
- Cualquier imagen que evoque "artesanal orgulloso" o "tostadurías de moda"

### Qué sí funciona

- Granos de café en superficie oscura con luz lateral cálida
- Manos preparando café (moka en hornilla, prensa francesa siendo presionada)
- Vapor, crema, textura del café recién hecho
- Empaque negro en contexto de cocina real
- Contraste naranja sobre negro cuando se necesita énfasis de marca

---

## 8. Producto y operación
...
Espresso · Moka · Prensa francesa · Filtro / pour over · Chemex · AeroPress · Grano entero

### Canal de venta

100% WhatsApp: +56 9 5117 2813. No hay tienda online ni carrito de compras. La conversación es el canal. El sitio web genera el lead y pre-llena el mensaje de WhatsApp con el pedido.
...
3. **La barrera eliminada es el molinillo.** Ese es el insight central del modelo de negocio. Todo lo que se genere debe asumir que el cliente no tiene molinillo y no quiere tener uno.
